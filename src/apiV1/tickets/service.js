...
/* ================================== FUNCTIONS ================================== */
async function sendMailFoo(message){
    try {
        ...
        logger.error(`{ function: 'sendMail(${message.to})', error: '${err.message}' }`);
    }   
}
async function mailer(req, res, next){
    ...
    await sendMailFoo(adminMessage);
    await sendMailFoo(userMessage);
}
/* ================================== SERVICES  ================================== */
class ticketService {
